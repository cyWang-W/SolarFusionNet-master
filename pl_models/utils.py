...
class ContextMixerModule(ABC, pl.LightningModule):
    ...
    def prepare_batch(self, batch, use_target=True):
        ...
        # )
        if use_target:
            return x_ts, x_ctx, y_ts, y_previous_ts, spatial_coords, ts_coords, time_coords
        # print("x_ts", x_ts.shape)
        # print("x_ctx", x_ctx.shape)
        # print("y_ts", y_ts.shape)
        # print("y_previous_ts", y_previous_ts.shape)
        # print("ctx_coords", ctx_coords.shape)
        # print("time_coords", ctx_coords.shape)
        return x_ts, x_ctx, spatial_coords, ts_coords, time_coords
